...
export class Top100Service {
    ...
    getTop100ForList(listName:String){ 
        ...
        return this._http.post('/rest/plugandplay/api/v1/top100/all',body,options).map(res => {
    ...
    removeFromTop100(id:Number,listName:String) { 
        ...
        return this._http.post('/rest/plugandplay/api/v1/top100/delete/',body,options)
            .map(res => res.json());
    }
