...
var CellComponent = (function () {
    ...
    CellComponent = __decorate([
        core_1.Component({
            ...
            <div *ngIf=\"!cell.getRow().isInEditing && cell.getColumn().id == 'companyname' && cell.getColumn().type !== 'html'\" style="font-size:20px;color:#2eb069;font-family:freight-sans-pro,sans-serif;">{{ cell.getValue() }}</div>\n
